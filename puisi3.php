...
<!-- BAGIAN KIRI -->
        <div class="kiri" style="margin: 0 15px 0px 30px">
				...
				<div class="kotak_link">
					<div id="teks_judul" >
						<h2>Ironi</h2>
						<p style="text-align: center; color: gray; font-size: 19px;"> By VV | 2020-04-20 </p>

						<p class="teks_isi" style="text-indent: 0%;">
                            Lalu mata nya berkaca-kaca, dada nya sesak, dunianya runtuh seketika<br>
                            Rasa-rasanya ia tidak dapat diselamatkan dari pria yang sangat ia cintai itu<br>
                            Yang juga membuatnya jatuh berkali-kali<br>
                            Yang telah berhasil membuatnya kehilangan pemahaman tentang cinta sejati<br>
                            Yang telah membuatnya tidak percaya lagi akan jatuh cinta yang lain selain jatuh padanya<br>
                            Mata polosnya (begitu orang-orang melihatnya) sebenarnya menyimpan banyak kesedihan<br> 
                            Dibalik keceriaannya, telah ia sembunyikan rapat-rapat semua kekalutan yang ada<br> 
                            Disamping lekuk bibirnya yang seperti bulan sabit itu,<br>
                            Sering ia diciumi oleh air matanya sendiri disetiap malam hingga pagi<br> 
                            Sungguh, jika kau melihat lebih dalam lagi, perempuan itu adalah Aku.<br><br>
						</p>
					</div>	
                </div>
...
<!-- BAGIAN KANAN -->
		<div id="kanan" >
			...
			<div class="right">
				...
				<div>
					<video width="270" control>
						<source src="Amigdala - Balada Puan.mp4" autoplay="true" type="video/mp4">
					</video>
				</div>
