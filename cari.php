...
<!-- BAGIAN KIRI -->
        <div class="kiri" style="margin: 0 15px 0px 30px">
            <h1 style="font-size: 40px; margin-left:100px;">Hasil pencarian dari.......... <?php echo $keyword; ?> </h1>

        <?php foreach( $rows as $puisi){
				echo "
				<div class='kotak'>
					<div class='gambar'>
					...
					<div class='teks' >
						...
						<span>".$puisi['author']."</span> | <span>".$puisi['tgl_karya']."</span>
