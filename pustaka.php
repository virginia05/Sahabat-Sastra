				...
				<div class="kotak_link">
					<div id="teks_judul">
						...
						<p style="text-indent: 40px; font-size:17px;">
					        Karya Sahabat Sastra yang sudah kami terima, telah terangkum dalam pustaka ini.. Sila dinikmati<br>
					           	<ol style="padding: 0 60px 20px;">
					           		<li><a href="puisi1.php">Antara Perempuan dan Wanita</a></li>
					           		<li><a href="puisi2.php">Bulan Baik</a></li>
					           		<li><a href="puisi3.php">Ironi</a></li>
					           		<li><a href="puisi4.php">Berselisih</a></li>
					           		<li><a href="puisi5.php">Tanya Rindu Ke Siapa???</a></li>
					           	</ol>
